...
import { StyledButtonGhostCrypto } from './Button.styled'
import {
...
export function ButtonGetStarted(props) {
  ...
  return (
    <button {...props} className={clsx('button-get-started', className)}>
  ...
  //   {
  //     ...props,
  //     className: clsx('button-get-started', className),
...
export function ButtonGetStartedLight(props) {
  ...
  return (
    <button
      {...props}
      className={clsx('button-get-started button-get-started-light', className)}
    >
      <StyledTypographyUrbanistCTA className='text'>
        {children}
      </StyledTypographyUrbanistCTA>
  ...
  //   {
  //     ...props,
  //     className: clsx('button-get-started-light', className),
  //   },
  //   [
  //     <StyledTypographyUrbanistCTA className='text'>
  //       {children}
...
export function ButtonLearnMore(props) {
  ...
  //   {
  //     ...props,
  //     className: clsx('button-learn-more', className),
  //   },
  //   [
  //     <StyledTypographyUrbanistCTA className='text'>
  //       {children}
