...
export function StyledButtonGhost({ children, className, ...props }) {
  return (
    <button {...props} className={clsx('button-ghost', className)}>
      {children}
    </button>
  )
}
export function StyledButtonSecondary({ children, className, ...props }) {
  return (
    <button {...props} className={clsx('button-secondary', className)}>
      {children}
    </button>
  )
}
...
//   }
// `
export function StyledButtonSecondaryLight({ children, className, ...props }) {
  return (
    <button
      {...props}
      className={clsx('button-secondary button-secondary-light', className)}
    >
      {children}
    </button>
  )
...
export function StyledButtonGhostCrypto({ children, className, ...props }) {
  return (
    <button
      {...props}
      className={clsx('button-ghost button-ghost-crypto', className)}
    >
      {children}
    </button>
  )
}
export function StyledButtonLearnMore({ children, className, ...props }) {
  return (
    <button
      {...props}
      className={clsx('button-get-started button-learn-more', className)}
    >
      {children}
    </button>
  )
