import {StyledTypographyUrbanistH1, StyledTypographyUrbanistH5} from '@/components/UI/Typography/Typography.styled';
  ...
  return (
    <StyledBlogsPageMainSection className="blogsPageMainSection">
      <div className="container">
        <StyledTypographyUrbanistH1 className="blogsPageTitle">
          Inqud insights
        ...
        <div className="blogsPageSearchWrapper">
          <InputSearch classNameWrapper="inputWrapper" placeholder="Search article, industry or product"/>
